...
\facultad{Facultad de Ciencias Médicas y Biológicas \break``Dr. Ignacio Chávez"}                 % Nombre de la facultad/escuela
...
\degree{Médico Cirujano y Partero}       % Carrera
...
\lugar{Morelia, Michoacán}                        % Lugar

\portadafalse                              % Portada en NEGRO, descomentar y comentar la línea siguiente si se quiere utilizar
%\portadatrue                                % Portada en COLOR

%\includepdf[pages=1]{portada_tesis.pdf}
...
\begin{document}
\begin{titlepage}
	\includepdf{portada_tesis.pdf}
\end{titlepage}
%\maketitle	 % Se redefinió este comando en el archivo de la clase para generar automáticamente la portada a partir de los datos
%\includepdf[pages=-,pagecommand={},width=\textwidth]{portada_tesis.pdf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                  PRÓLOGO                          %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frontmatter
